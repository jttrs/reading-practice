...
ARPABET_TO_AUDIO: dict[str, dict[str, str]] = {
    ...
    # --- Fricatives ---
    "DH": {"audio_id": "thh",  "ipa": "ðə"},
    "F":  {"audio_id": "fff",  "ipa": "fə"},
    "HH": {"audio_id": "huh",  "ipa": "hə"},
    "S":  {"audio_id": "sss",  "ipa": "sə"},
    "SH": {"audio_id": "shh",  "ipa": "ʃə"},
    "TH": {"audio_id": "thh",  "ipa": "θə"},
    "V":  {"audio_id": "vvv",  "ipa": "və"},
    "Z":  {"audio_id": "zzz",  "ipa": "zə"},
    "ZH": {"audio_id": "zhuh", "ipa": "ʒə"},
    # --- Nasals ---
    "M":  {"audio_id": "mmm",  "ipa": "mə"},
    "N":  {"audio_id": "nnn",  "ipa": "nə"},
    "NG": {"audio_id": "ng",   "ipa": "ŋə"},
    # --- Liquids ---
    "L":  {"audio_id": "lll",  "ipa": "lə"},
    "R":  {"audio_id": "rrr",  "ipa": "ɹə"},
    # --- Semivowels / Glides ---
